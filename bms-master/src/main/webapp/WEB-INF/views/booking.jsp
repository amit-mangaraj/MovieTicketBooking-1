  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <div class="main">
        <div class="card card-outline-secondary" style="background-color: lightblue;">
            ...
            <div class="card-body">
                <form autocomplete="off" class="form" role="form" action="/addbooking" method="post">
                <!-- <div class="form-group row">
                    ...
                    <%-- <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input class="form-control" type="number" name="miid">
                        </div>
                         <h1>${rs }</h1>
                    </div> --%>
                    <div class="form-group row">
                    ...
                    <%-- <h1>Available seats</h1><h1> ${remseats } </h1> --%>
                 <div class="form-group row">
